...
Our feed reader will pull feeds from our favorite blogs. The user will be able to
...
This will be a first single page app. All of our application views will be
